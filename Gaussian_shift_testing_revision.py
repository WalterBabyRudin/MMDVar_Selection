...
for trial in range(n_run):
    ...
    if input_method == "QMMD":
        ...
        z_quadratic_MMD, obj_z_quadratic_MMD = Quadratic_MMD.Quad_MMD_training_revision(X_Tr, Y_Tr, c, Lambda, d=d_proj, z0=z_linear_MMD, tau=tau, num_epoch=30, sigma=2)
...
np.save("Gaussian_power_"+input_method+"_"+str(L)+".npy", np.array(Power_nrun_hist))
